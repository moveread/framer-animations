...
export { Slideshow, type Direction } from './Slideshow'
...
export { Highlighted, useHighlight, type Config as HighlightedConfig, type Hook as HighlightedHook, type Props as HighlightedProps } from './highlighted'